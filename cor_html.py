...
def correction(file_o):
	...
	for i in f_init :
		...
		line=line.replace("nowrap=\"true\" align=\"left\"", "align=\"left\" nowrap") # remplacement des erreurs dans le fichier html    
		line=line.replace("<td valign=\"center\"", "<td valign=\"middle\"") # remplacement des erreurs dans le fichier html
