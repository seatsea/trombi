...
def construct_grp(list_grp):
    ...
    for i in list_grp:
        ...
        a = file_init.write('<html><head><meta http-equiv=\"content-type\" content=\"text/html; charset=UTF-8\"><title>Groupe %s</title></head><body><p>Page du Groupe %s </p></body></html>' %(i,i))
